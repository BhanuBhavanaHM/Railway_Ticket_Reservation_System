...
<!-- Navigation bar -->
		...
		<div class="row">
			...
			<div class="span4 well" style="margin-top: 20px">
			...
			<table class="table">
				...
				<tr>
					<td style="border-top:0px;"><input class="btn btn-danger" type="submit" value="OK"></td>
					<td style="border-top:0px;"><a href="reservation.php" class="btn btn-danger" type="reset" value="Reset">Reset</a></td>
				</tr>
			</table>
			</form>
			</div>
		...
		<!-- display train -->
			<div class="span8 well" style="margin-top: 20px">
